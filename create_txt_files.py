            ...
            for pth in contents:
                ...
                if os.path.split(pth)[-1][:3]=='rgb':
                    ...
                    if match:
                        ...
                        #print(f"number_before_png: {remove_leading_zeros(number_before_png)}")
                        
                        #print(f"data.iloc[]: {data.iloc[remove_leading_zeros(number_before_png)]['focal_length']}")
                        ...
                        #focal_length = data.iloc[remove_leading_zeros(number_before_png)]['focal_length']
                        ...
                        #print(f"{png_pth} {depth_pth} {510}")
                        file.write(f"{png_pth} {depth_pth} {focal_length}{new_line}")
